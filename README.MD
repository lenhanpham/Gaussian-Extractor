...
The build system automatically handles the known issues with Intel oneAPI 202x.x:

**std::filesystem Linking Issue:**
...
```
The build system automatically adds the `-lstdc++fs` flag for Intel oneAPI 202x.x.
