...
void ConfigManager::print_config_file_template()
{
    ...
    std::cout << "# Save this as .gaussian_extractor.conf in your home directory or current working directory"
              << std::endl;
    std::cout << "#" << std::endl;
...
namespace ConfigUtils
{
    ...
    std::string get_config_search_paths()
    {
        ...
        oss << "  " << sys_num << ". /etc/gaussian_extractor/" << ALT_CONFIG_FILENAME << "\n";
